...
function Sidebar({ onToggleInfos }) {
    ...
    <>
      <section className="container-sidebar">
        ...
        <div className="div-links">
          <ul>
            <li>
              <NavLink className={getClass} to="/vendas">
                <FontAwesomeIcon icon={faCartShopping} />
              </NavLink>
            </li>
            <li>
              <NavLink className={getClass} to="/produtos/filterProdutos">
                <FontAwesomeIcon icon={faDollarSign} />
              </NavLink>
            </li>
            <li>
              <NavLink className={getClass} to="/historico">
                <FontAwesomeIcon icon={faClock} />
              </NavLink>
            </li>
            <li>
              <NavLink className={getClass} to="/analises">
        ...
        <div className="div-infos">
          <ul>
            <li>
              <NavLink className={getClass} to={"/fecharPdv"}>
